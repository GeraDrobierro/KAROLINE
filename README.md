...
Так, теперь, постоянно прописывать os.system(‘say ‘ + ‘текст’) неудобно, долго, муторно и друг к негативные прилагательные. создадим функцию, с помощью которой будет говорить Каролина 
